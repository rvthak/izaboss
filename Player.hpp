...
class Player {
	...
	public:
		...
		// Support functions
		unsigned int Player::getPlayerManPower();		// Return the total attach of all the players personalities
		unsigned int Player::getPotentialIncome();		// Return the total amount of revenue generated by all of the player's holdings
